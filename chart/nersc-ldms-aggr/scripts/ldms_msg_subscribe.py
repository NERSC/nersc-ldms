...
# -*- coding: utf-8 -*-
"""
LDMS Message Subscriber

Subscribes to and displays LDMS daemon messages via the msg-api for monitoring.
"""
...
parser = argparse.ArgumentParser(description='Subscribe to LDMS messages via msg-api')
