...
# -*- coding: utf-8 -*-
"""
LDMS Message Publisher

Publishes messages to LDMS daemon via the msg-api for testing and monitoring.
"""
...
parser = argparse.ArgumentParser(description='Publish LDMS message via msg-api')
